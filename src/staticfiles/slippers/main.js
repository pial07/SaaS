...
!(function () {
  ...
  !(function () {
    ...
    function u(e) {
      ...
      return (
        n.touches.length > 1 || (n.preventDefault && n.preventDefault(), !1)
      );
    }
    var i =
        a &&
                    ...
                    i
                      ? ((e.ontouchmove = null),
                        f &&
                          ...
                          })(document, "touchmove", u),
                          (f = !1)))
                      : (e.style.overflow = n.initialOverflow))
                  : s.set(e, {
                      counter: n.counter - 1,
                      initialOverflow: n.initialOverflow,
                    }));
            };
            (0, e.useEffect)(
              function () {
                          ...
                          : (s.set(e, {
                            ...
                            i
                              ? f ||
                                ...
                                })(document, "touchmove", u, { passive: !1 }),
                                (f = !0))
          ...
          children: [
            ...
            (0, p.jsx)("ul", {
              ...
              children: a.map(function (e, n) {
                return (0,
                p.jsxs)("li", { children: ["invalid" === e.error && (0, p.jsxs)("span", { children: ["Invalid prop ", (0, p.jsx)(m, { children: e.name }), " set on", " ", (0, p.jsx)(h, { children: t }), ". Expected", " ", (0, p.jsx)(v, { children: e.expected }), ", got", " ", (0, p.jsx)(v, { children: e.actual }), "."] }), "missing" === e.error && (0, p.jsxs)("span", { children: ["Required prop ", (0, p.jsx)(m, { children: e.name }), " of type", " ", (0, p.jsx)(v, { children: e.expected }), " not set on", " ", (0, p.jsx)(h, { children: t }), "."] }), "extra" === e.error && (0, p.jsxs)("span", { children: ["Extra prop ", (0, p.jsx)(m, { children: e.name }), " of type", " ", (0, p.jsx)(v, { children: e.actual }), " set on", " ", (0, p.jsx)(h, { children: t }), "."] })] }, n);
              }),
            }),
          ],
        });
      ...
      y = function (e) {
        ...
        return (0, p.jsx)("div", {
          className:
            "fixed inset-0 bg-black/90 text-white p-4 md:p-12 overflow-auto",
    ...
    var b = function (n) {
      ...
      return (
        ...
        d(a),
        (0, p.jsx)(p.Fragment, {
          children: a && (0, p.jsx)(y, { errors: t, setShowModal: o }),
        })
      );
    };
    document.addEventListener("DOMContentLoaded", function () {
      var t,
        r = window.slippersPropErrors || [],
        l = JSON.parse(
          (null ===
            (t = document.getElementById("slippers_type_checking_output")) ||
          void 0 === t
            ? void 0
            : t.textContent) || "[]"
        );
      r.length > 0 &&
            ...
            console.group("Slippers: Failed prop types"),
              e.forEach(function (e) {
                console.groupCollapsed(
                  ""
                    .concat(e.tag_name, " in ")
                    .concat(e.template_name, ":")
                    .concat(e.lineno)
                ),
                  e.errors.forEach(function (n) {
                    "invalid" === n.error
                      ? console.error(
                          "Invalid prop "
                            .concat(n.name, " set on ")
                            .concat(e.tag_name, ". Expected ")
                            .concat(n.expected, ", got ")
                            .concat(n.actual, ".")
                        )
                      : "missing" === n.error
                      ? console.error(
                          "Required prop "
                            .concat(n.name, " of type ")
                            .concat(n.expected, " not set on ")
                            .concat(e.tag_name, ".")
                        )
                      : "extra" === n.error &&
                        console.error(
        ...
        l.includes("overlay") &&
          n
            .createRoot(document.getElementById("slippers_errors_ui_root"))
            .render(
              (0, p.jsx)(e.StrictMode, {
                children: (0, p.jsx)(b, { errors: r }),
              })
            ));
    });
  })();
